...
export class Test {
  ...
  run() {
    this.results["queryCommandSupported"] =
    ...
    this.results["post_teardown.enabled"] =
...
export namespace Test {
  export class Plain extends Test {
    copyListener(e: ClipboardEvent) {
      ...
      this.results["pre_setData.text_plain"] =
        e.clipboardData!.getData("text/plain");
      e.clipboardData!.setData("text/plain", "Plain");
      this.results["post_setData.text_plain"] =
        e.clipboardData!.getData("text/plain");
      e.preventDefault();
    }
  }
  ...
  export class SelectTempElemUserSelectNoneNested extends Test {
    ...
    copyListener(e: ClipboardEvent) {
      ...
      e.clipboardData!.setData(
        "text/plain",
        "SelectTempElemUserSelectNoneNested",
      );
      this.results["post_setData.text_plain"] =
        e.clipboardData!.getData("text/plain");
      e.preventDefault();
  ...
  export class CopyTempElem extends Test {
    ...
    copyListener(e: ClipboardEvent) {
      ...
      this.results["no_setData.text_plain"] =
        e.clipboardData!.getData("text/plain");
    }
    teardown() {
      this.clearSelection();
  ...
  export class WindowClipboardData extends Test {
    ...
    run() {
      ...
      (window as any as IEWindow).clipboardData!.setData(
        "Text",
        "WindowClipboardData",
      );

...
Note: As of mid-2020, the stable releases of all modern browsers implement `navigator.clipboard.writeText()`. Use this library only if you need to copy other data types, or need to support older browsers.
